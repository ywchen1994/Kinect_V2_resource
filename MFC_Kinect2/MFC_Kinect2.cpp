...
BEGIN_MESSAGE_MAP(CMFC_Kinect2App, CWinApp)
...
CMFC_Kinect2App::CMFC_Kinect2App()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMFC_Kinect2App 物件

CMFC_Kinect2App theApp;


// CMFC_Kinect2App 初始設定

BOOL CMFC_Kinect2App::InitInstance()
{
