...
MFC_Kinect2Dlg.h、MFC_Kinect2Dlg.cpp - 對話方塊
    這些檔案包含您的 CMFC_Kinect2Dlg 類別。這個類別會定義應用程式主對話方塊的行為。對話方塊的範本是在可於 Microsoft Visual C++ 編輯的 MFC_Kinect2.rc 中。
...
StdAfx.h, StdAfx.cpp
    這些檔案是用來建置名為 MFC_Kinect2.pch 的先行編譯標頭 (PCH) 檔，以及名為 StdAfx.obj 的先行編譯型別檔。

Resource.h
    這是標準標頭檔，它定義新的資源 ID。Microsoft Visual C++ 會讀取和更新這個檔案。

MFC_Kinect2.manifest
