...
void Kinect2Capture::Color2CameraSpace(CvPoint RGBpoint,CvPoint3D32f *CameraSpace)
{
...
void  Kinect2Capture::Depth2CameraSpace(CvPoint Depthpoint, CvPoint3D32f *CameraSpace)
{
...
void Kinect2Capture::Color2DepthSpace(CvPoint RGBpoint,CvPoint *Depthpoint)
{
...
void Kinect2Capture::Depth2ColorSpace(CvPoint Depthpoint,CvPoint* RGBpoint)/*未完成*/
{
